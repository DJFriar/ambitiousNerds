...
const PrivacyPolicy = () => {
  return (
    <Layout>
      ...
      />
      <section className="privacy-policy-area ptb-50">
        <div className="container">
          <div className="row">
            <div className="col-lg-12 col-md-12">
              <div className='privacy-policy-content'>
              <p><i>This Privacy Policy was last updated on February 1, 2022.</i></p>
              <h2>Purpose</h2>
              ...
              <ul>
                ...
                <li>
                  <strong>Application</strong> means the software program provided by the Company downloaded by You on any
                    electronic device, named Tour of Honor
                </li>
                <li>
                  <strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                    &quot;Our&quot; in this Agreement) refers to Ambitious Nerds, LLC, 7909 Sloan Cir, Plano TX 75025.
                </li>
                <li>
              ...
              <p>We use this information to provide features of Our Service, to improve and customize Our Service. The information may
                be uploaded to the Company's servers and/or a Service Provider's server or it may be simply stored on Your device.</p>
              ...
              <h2>Contact Us</h2>
              <p>If you have any questions about this Privacy Policy, You can contact us by email: legal@ambitiousnerds.com.</p>
              </div>
            </div>
          </div>
        </div>
